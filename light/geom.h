...
void nonsphericalparticle(iREAL eps, iREAL radius, int pointsize, int &nt, int nb, int idx, iREAL *t[6][3], int tid[], int pid[], iREAL *position[6], iREAL *mint, iREAL *maxt);
