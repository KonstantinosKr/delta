...
std::vector<contactpoint> gjk(
  ...
  double *a = new double[numberOfTrianglesOfGeometryA*3];
  double *b = new double[numberOfTrianglesOfGeometryB*3];
  double p[3], q[3];
...
double delta::collision::gjk (double *a, int na, double *b, int nb, double *p, double *q)
{
  point w [4];
  double v [3], vlen, delta, mi = 0.0, l [4];
