...
#ifndef MYPROJECT_MAPPINGS_RefineDynamically_H_
#define MYPROJECT_MAPPINGS_RefineDynamically_H_
 ...
 */
class myproject::mappings::RefineDynamically {
  private:
    /**
  ...
  public:
     ...
     */
    RefineDynamically(const RefineDynamically& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~RefineDynamically();
     ...
     */   
    void mergeWithWorkerThread(const RefineDynamically& workerThread);
    #endif
