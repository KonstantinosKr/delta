#include "peano/grid/tests/records/TestCell.h"
   ...
   peano::grid::tests::records::TestCellPacked peano::grid::tests::records::TestCell::convert() const{
      ...
      void peano::grid::tests::records::TestCell::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
      ...
      void peano::grid::tests::records::TestCell::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
         MPI_Request* sendRequestHandle = new MPI_Request();
         MPI_Status   status;
         int          flag = 0;
         int          result;
   ...
   _packedRecords0 = static_cast<int>(_packedRecords0 | state << (1));
   }
   ...
   _persistentRecords._packedRecords0 = static_cast<int>(_persistentRecords._packedRecords0 | state << (1));
   }
   ...
   peano::grid::tests::records::TestCell peano::grid::tests::records::TestCellPacked::convert() const{
      ...
      void peano::grid::tests::records::TestCellPacked::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
         MPI_Request* sendRequestHandle = new MPI_Request();
         MPI_Status   status;
         int          flag = 0;
         int          result;
      ...
      void peano::grid::tests::records::TestCellPacked::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
         MPI_Request* sendRequestHandle = new MPI_Request();
         MPI_Status   status;
         int          flag = 0;
         int          result;
