...
#ifndef MULTIGRID_MAPPINGS_JacobiSmoother_H_
#define MULTIGRID_MAPPINGS_JacobiSmoother_H_
 ...
 */
class multigrid::mappings::JacobiSmoother {
  private:
    /**
  ...
  public:
     ...
     */
    JacobiSmoother(const JacobiSmoother& masterThread);
    #endif
     ...
     */   
    void mergeWithWorkerThread(const JacobiSmoother& workerThread);
    #endif
