...
#ifndef MULTIGRID_MAPPINGS_MultiplicativeMG_H_
#define MULTIGRID_MAPPINGS_MultiplicativeMG_H_
 ...
 */
class multigrid::mappings::MultiplicativeMG {
  private:
    /**
  ...
  public:
     ...
     */
    MultiplicativeMG(const MultiplicativeMG& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~MultiplicativeMG();
     ...
     */   
    void mergeWithWorkerThread(const MultiplicativeMG& workerThread);
    #endif
