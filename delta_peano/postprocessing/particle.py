...
listParticleLogs=os.listdir("../")
listParticleLogs = [k for k in listParticleLogs if 'particle' in k]
listParticleLogs.sort()

listParticleLogs.insert(0, listParticleLogs[-1])
listParticleLogs.pop()

print listParticleLogs

particleFile = open("../particle.log", "r")
...
for filepath in listParticleLogs:
