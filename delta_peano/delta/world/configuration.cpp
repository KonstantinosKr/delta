...
delta::world::configuration::configuration::configuration() {
//this->_insitufineObjects = _insitufineObjects;
}
...
iREAL delta::world::configuration::getDiscritization(
    iREAL length,
    int number)
{
...
std::vector<std::array<iREAL, 3>> delta::world::configuration::array1d(
    iREAL position[3],
    iREAL xAxisLength,
    int partsNo)
{
...
std::vector<std::array<iREAL, 3>> delta::world::configuration::array2d(
    iREAL position[3],
    iREAL xyAxisLength,
    int partsNo)
{
	...
	{
		std::vector<std::array<iREAL, 3>> tmp = delta::world::configuration::array1d(position, xyAxisLength, partsNo);
...
std::vector<std::array<iREAL, 3>> delta::world::configuration::array3d(
    iREAL position[3],
    iREAL xyzAxisLength,
    int partsNo)
{
  ...
  iREAL resetx = position[0];
	...
	for(int i=0;i<partsNo;i++)
	{
		std::vector<std::array<iREAL, 3>> tmp = delta::world::configuration::array2d(position, xyzAxisLength, partsNo);
		for(std::vector<std::array<iREAL, 3>>::iterator j = tmp.begin(); j != tmp.end(); j++)
		{
			array.push_back(*j);
		}
    ...
    int partsYNo)
{
	...
	{
		std::vector<std::array<iREAL, 3>> tmp = delta::world::configuration::array2d(position, xyzAxisLength, partsXYZNo);
		for(std::vector<std::array<iREAL, 3>>::iterator j = tmp.begin(); j != tmp.end(); j++)
		{
			array.push_back(*j);
		}
...
void delta::world::configuration::collapseUniformGrid(
	iREAL position[3],
...
std::vector<std::array<iREAL, 3>> delta::world::configuration::getGridArrayList(
    iREAL position[3],
    int xzcuts,
    int ycuts,
    iREAL width)
{
  return delta::world::configuration::array3d(position, width, xzcuts, width, ycuts);
}

void delta::world::configuration::uniform(
      iREAL totalMass,
      int index,
      bool isSphereOrNone,
      ...
      std::vector<delta::world::Object> &_insitufineObjects)
{
  ...
  if(isSphereOrNone)
  {
    delta::world::configuration::uniSphereRadius(totalMass, index, _insitufineObjects);
  } else {
    delta::world::configuration::uniMeshGeometry(totalMass, noPointsPerParticle, _insitufineObjects, index);
...
void delta::world::configuration::nonuniform(
          iREAL totalMass,
          int index,
          ...
          std::vector<delta::world::Object> &_insitufineObjects)
{
  if(isSphereOrNone)
  {
    delta::world::configuration::nonUniSphereRadius(totalMass, index, subcellx, _insitufineObjects);
  } else {
	...
	std::vector<delta::world::Object>& _insitufineObjects)
{
  ...
  iREAL xzWCell = delta::world::configuration::getDiscritization(arrayXZlength, elements);
  ...
  for(int i=0; i<layers; i++)
  {
    ...
    std::vector<std::array<iREAL, 3>> tmp = delta::world::configuration::array2d(position, arrayXZlength, elements);
    ...
    std::vector<delta::world::Object>& _insitufineObjects)
{
  ...
  ///place components of 2d array structure
  iREAL xzWCell = delta::world::configuration::getDiscritization(arrayXZlength, xzElements);
  ...
  std::vector<std::array<iREAL, 3>> particleGrid = delta::world::configuration::array3d(position, arrayXZlength, xzElements, arrayYlength, yElements);

  delta::world::configuration::collapseUniformGrid(position, particleGrid, xzElements, yElements, width, height, 0);
