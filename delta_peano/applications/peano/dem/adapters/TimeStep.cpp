...
dem::adapters::TimeStep::TimeStep() {
}
...
dem::adapters::TimeStep::TimeStep(const TimeStep&  masterThread):
...
void dem::adapters::TimeStep::mergeWithWorkerThread(const TimeStep& workerThread) {
...
void dem::adapters::TimeStep::createHangingVertex(
...
void dem::adapters::TimeStep::destroyHangingVertex(
...
void dem::adapters::TimeStep::createInnerVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStep::createBoundaryVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStep::destroyVertex(
      const dem::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::TimeStep::createCell(
...
void dem::adapters::TimeStep::destroyCell(
...
#ifdef Parallel
void dem::adapters::TimeStep::mergeWithNeighbour(
  dem::Vertex&  vertex,
...
void dem::adapters::TimeStep::prepareSendToNeighbour(
  dem::Vertex&  vertex,
  int                                           toRank,
...
void dem::adapters::TimeStep::prepareCopyToRemoteNode(
...
void dem::adapters::TimeStep::mergeWithRemoteDataDueToForkOrJoin(
  dem::Vertex&  localVertex,
...
bool dem::adapters::TimeStep::prepareSendToWorker(
  dem::Cell&                 fineGridCell,
  dem::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStep::prepareSendToMaster(
  dem::Cell&                       localCell,
  dem::Vertex *                    vertices,
...
void dem::adapters::TimeStep::mergeWithMaster(
...
void dem::adapters::TimeStep::receiveDataFromMaster(
...
void dem::adapters::TimeStep::mergeWithWorker(
  dem::Cell&           localCell, 
...
void dem::adapters::TimeStep::touchVertexFirstTime(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStep::touchVertexLastTime(
      dem::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::TimeStep::enterCell(
      dem::Cell&                 fineGridCell,
      dem::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStep::leaveCell(
      dem::Cell&           fineGridCell,
      dem::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::TimeStep::beginIteration(
...
void dem::adapters::TimeStep::endIteration(
  dem::State&  solverState
) {
...
void dem::adapters::TimeStep::descend(
...
void dem::adapters::TimeStep::ascend(
  dem::Cell * const    fineGridCells,
  dem::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  dem::Vertex * const  coarseGridVertices,
