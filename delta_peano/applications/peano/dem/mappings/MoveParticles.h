 ...
 * Move particles
 *
 * The name is slightly misleading. This mapping does move the particle, i.e.
 * update its position. However, it also does all the resorting. It reassigns
 * the particles/triangles to new vertices if this is required.
 * 
 * The position update is done in touchVertexFirstTime().
 *
 * @author Peano Development Toolkit (PDT) by  Tobias Weinzierl
 * @version $Revision: 1.1 $
 */
class dem::mappings::MoveParticles {
  private:
    /**
