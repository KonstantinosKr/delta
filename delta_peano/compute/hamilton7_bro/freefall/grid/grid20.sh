...
exp1="./dem-3d-release-vec 0.1 freefallWithGranulates 1000 regular-grid 0.0001 never 10 true bf 20"
exp2="./dem-3d-release-vec 0.1 freefallWithGranulates 1000 adaptive-grid 0.0001 never 10 true bf 20"
exp3="./dem-3d-release-vec 0.1 freefallWithGranulates 1000 reluctant-grid 0.0001 never 10 true bf 20"
