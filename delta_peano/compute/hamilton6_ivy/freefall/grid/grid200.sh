...
exp1="./dem-3d-release-vec 0.1 freefallWithGranulates 5000 regular-grid 0.0001 never 10 true bf 200"
exp2="./dem-3d-release-vec 0.1 freefallWithGranulates 5000 adaptive-grid 0.0001 never 10 true bf 200"
exp3="./dem-3d-release-vec 0.1 freefallWithGranulates 5000 reluctant-grid 0.0001 never 10 true bf 200"
