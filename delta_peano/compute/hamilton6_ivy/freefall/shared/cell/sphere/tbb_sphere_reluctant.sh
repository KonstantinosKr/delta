...
exp0="./dem-3d-release-tbb 0.1 freefallWithGranulates 5000 reluctant-grid 0.0001 never 10 true sphere 0.1 1"
exp1="./dem-3d-release-tbb 0.1 freefallWithGranulates 5000 reluctant-grid 0.0001 never 10 true sphere 0.1 2"
exp2="./dem-3d-release-tbb 0.1 freefallWithGranulates 5000 reluctant-grid 0.0001 never 10 true sphere 0.1 3"
exp3="./dem-3d-release-tbb 0.1 freefallWithGranulates 5000 reluctant-grid 0.0001 never 10 true sphere 0.1 4"
exp4="./dem-3d-release-tbb 0.1 freefallWithGranulates 5000 reluctant-grid 0.0001 never 10 true sphere 0.1 6"
exp5="./dem-3d-release-tbb 0.1 freefallWithGranulates 5000 reluctant-grid 0.0001 never 10 true sphere 0.1 8"
exp6="./dem-3d-release-tbb 0.1 freefallWithGranulates 5000 reluctant-grid 0.0001 never 10 true sphere 0.1 16"
