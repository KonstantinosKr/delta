...
nohup ./dem-3d-release-tbb-omp-triangle 0.1 0.001 0.1 freefall 5000 reluctant-grid 0.0001 never 10 true bf 20 8 | tee rel20Grid.log &
...
nohup ./dem-3d-release-tbb-omp-triangle 0.1 0.001 0.1 freefall 5000 reluctant-grid 0.0001 never 10 true bf 200 8 | tee rel200Grid.log &
...
nohup ./dem-3d-release-tbb-omp-triangle 0.1 0.001 0.1 freefall 5000 reluctant-grid 0.0001 never 10 true bf 2000 8 | tee rel2000Grid.log & 