...
exp1="./dem-3d-release-vec 0.5 0.5 0.5 random-velocities 10000 regular-grid 0.0001 never 1 10 sphere 0.1"
exp2="./dem-3d-release-vec 0.5 0.5 0.5 random-velocities 10000 adaptive-grid 0.0001 never 0 sphere 0.1"
exp3="./dem-3d-release-vec 0.5 0.5 0.5 random-velocities 10000 adaptive-grid 0.0001 never 1 10 sphere 0.1"
