...
exp1="./delta-release-vec 0.1 freefallWithGranulates 1000 regular-grid 0.0001 never 10 true bf 200"
exp2="./delta-release-vec 0.1 freefallWithGranulates 1000 adaptive-grid 0.0001 never 10 true bf 200"
exp3="./delta-release-vec 0.1 freefallWithGranulates 1000 reluctant-grid 0.0001 never 10 true bf 200"
