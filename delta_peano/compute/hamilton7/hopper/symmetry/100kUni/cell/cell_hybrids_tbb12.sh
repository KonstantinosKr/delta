...
exp0="./delta-release-tbb-omp-triangle 0.1 hopperUniform100k 1000 reluctant-grid 0.00003 never 10 true hybrid-on-triangle-pairs 10 12"
exp1="./delta-release-tbb-omp-triangle 0.1 hopperUniform100k 1000 reluctant-grid 0.00003 never 10 true hybrid-on-batches 10 12"
exp2="./delta-release-tbb-omp-triangle 0.1 hopperUniform100k 1000 reluctant-grid 0.00003 never 10 true hybrid-on-triangle-pairs 20 12"
exp3="./delta-release-tbb-omp-triangle 0.1 hopperUniform100k 1000 reluctant-grid 0.00003 never 10 true hybrid-on-batches 20 12"
exp4="./delta-release-tbb-omp-triangle 0.1 hopperUniform100k 1000 reluctant-grid 0.00003 never 10 true hybrid-on-triangle-pairs 40 12"
exp5="./delta-release-tbb-omp-triangle 0.1 hopperUniform100k 1000 reluctant-grid 0.00003 never 10 true hybrid-on-batches 40 12"
exp6="./delta-release-tbb-omp-triangle 0.1 hopperUniform100k 1000 reluctant-grid 0.00003 never 10 true hybrid-on-triangle-pairs 80 12"
exp7="./delta-release-tbb-omp-triangle 0.1 hopperUniform100k 1000 reluctant-grid 0.00003 never 10 true hybrid-on-batches 80 12"
