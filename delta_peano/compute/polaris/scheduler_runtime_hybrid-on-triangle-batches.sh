...
exp0="./dem-3d-release-novec 0.5 0.5 0.5 random-velocities 500 reluctant-grid 0.001 never 0 hybrid-on-batches"
exp1="./dem-3d-release-novec 0.5 0.5 0.5 random-velocities 500 reluctant-grid 0.001 never 1 10 hybrid-on-batches"
exp2="./dem-3d-release-novec 0.05 0.05 random-velocities 500 reluctant-grid 0.001 never 0 hybrid-on-batches"
exp3="./dem-3d-release-novec 0.05 0.05 random-velocities 500 reluctant-grid 0.001 never 1 10 hybrid-on-batches"
exp4="./dem-3d-release-novec 0.05 0.01 random-velocities 500 reluctant-grid 0.001 never 0 hybrid-on-batches"
exp5="./dem-3d-release-novec 0.05 0.01 random-velocities 500 reluctant-grid 0.001 never 1 10 hybrid-on-batches"
exp6="./dem-3d-release-novec 0.05 0.001 random-velocities 500 reluctant-grid 0.001 never 0 hybrid-on-batches"
exp7="./dem-3d-release-novec 0.05 0.001 random-velocities 500 reluctant-grid 0.001 never 1 10 hybrid-on-batches"
