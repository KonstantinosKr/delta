...
exp1="./dem-3d-release-vec 0.5 0.5 0.5 random-velocities 500 reluctant-adaptive-grid 0.001 never 1 10 penalty"
exp2="./dem-3d-release-vec 0.05 0.05 random-velocities 500 reluctant-adaptive-grid 0.001 never 0 penalty"
exp3="./dem-3d-release-vec 0.05 0.05 random-velocities 500 reluctant-adaptive-grid 0.001 never 1 10 penalty"
exp4="./dem-3d-release-vec 0.05 0.01 random-velocities 500 reluctant-adaptive-grid 0.001 never 0 penalty"
exp5="./dem-3d-release-vec 0.05 0.01 random-velocities 500 reluctant-adaptive-grid 0.001 never 1 10 penalty"
exp6="./dem-3d-release-vec 0.05 0.001 random-velocities 500 reluctant-adaptive-grid 0.001 never 0 penalty"
exp7="./dem-3d-release-vec 0.05 0.001 random-velocities 500 reluctant-adaptive-grid 0.001 never 1 10 penalty"
