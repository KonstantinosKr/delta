...
int dem::adapters::TimeStepAndPlot2VTKGridVisualiser_3::_snapshotCounter = 0;
...
std::map<tarch::la::Vector<DIMENSIONS,double> , int, tarch::la::VectorCompare<DIMENSIONS> >  dem::adapters::TimeStepAndPlot2VTKGridVisualiser_3::_vertex2IndexMap;
