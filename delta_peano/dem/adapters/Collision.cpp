...
peano::CommunicationSpecification   dem::adapters::Collision::communicationSpecification() const {
...
peano::MappingSpecification   dem::adapters::Collision::touchVertexLastTimeSpecification(int level) const {
...
peano::MappingSpecification   dem::adapters::Collision::touchVertexFirstTimeSpecification(int level) const { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::Collision::enterCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::Collision::leaveCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::Collision::ascendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::Collision::descendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
dem::adapters::Collision::Collision() {
}
...
dem::adapters::Collision::Collision(const Collision&  masterThread):
...
void dem::adapters::Collision::mergeWithWorkerThread(const Collision& workerThread) {
...
void dem::adapters::Collision::createHangingVertex(
...
void dem::adapters::Collision::destroyHangingVertex(
...
void dem::adapters::Collision::createInnerVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::Collision::createBoundaryVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::Collision::destroyVertex(
      const dem::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::Collision::createCell(
...
void dem::adapters::Collision::destroyCell(
...
#ifdef Parallel
void dem::adapters::Collision::mergeWithNeighbour(
  dem::Vertex&  vertex,
...
void dem::adapters::Collision::prepareSendToNeighbour(
  dem::Vertex&  vertex,
  int                                           toRank,
...
void dem::adapters::Collision::prepareCopyToRemoteNode(
...
void dem::adapters::Collision::mergeWithRemoteDataDueToForkOrJoin(
  dem::Vertex&  localVertex,
...
bool dem::adapters::Collision::prepareSendToWorker(
  dem::Cell&                 fineGridCell,
  dem::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::Collision::prepareSendToMaster(
  dem::Cell&                       localCell,
  dem::Vertex *                    vertices,
...
void dem::adapters::Collision::mergeWithMaster(
...
void dem::adapters::Collision::receiveDataFromMaster(
...
void dem::adapters::Collision::mergeWithWorker(
  dem::Cell&           localCell, 
...
void dem::adapters::Collision::touchVertexFirstTime(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::Collision::touchVertexLastTime(
      dem::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::Collision::enterCell(
      dem::Cell&                 fineGridCell,
      dem::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::Collision::leaveCell(
      dem::Cell&           fineGridCell,
      dem::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::Collision::beginIteration(
...
void dem::adapters::Collision::endIteration(
  dem::State&  solverState
) {
...
void dem::adapters::Collision::descend(
...
void dem::adapters::Collision::ascend(
  dem::Cell * const    fineGridCells,
  dem::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  dem::Vertex * const  coarseGridVertices,
