...
#ifndef DEM_ADAPTERS_TimeStepAndPlotOnReluctantDynamicGrid_H_
#define DEM_ADAPTERS_TimeStepAndPlotOnReluctantDynamicGrid_H_
...
namespace dem {
      namespace adapters {
        class TimeStepAndPlotOnReluctantDynamicGrid;
      } 
}
...
class dem::adapters::TimeStepAndPlotOnReluctantDynamicGrid {
  private:
    ...
    typedef mappings::ReluctantlyAdoptGrid Mapping2;
    ...
    typedef adapters::TimeStepAndPlotOnReluctantDynamicGrid2VTKGridVisualiser_4 Mapping4;
     ...
     Mapping2  _map2ReluctantlyAdoptGrid;
     Mapping3  _map2Plot;
  ...
  public:
    ...
    TimeStepAndPlotOnReluctantDynamicGrid();

    #if defined(SharedMemoryParallelisation)
    TimeStepAndPlotOnReluctantDynamicGrid(const TimeStepAndPlotOnReluctantDynamicGrid& masterThread);
    #endif

    virtual ~TimeStepAndPlotOnReluctantDynamicGrid();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const TimeStepAndPlotOnReluctantDynamicGrid& workerThread);
    #endif
