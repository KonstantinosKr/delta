...
peano::CommunicationSpecification   dem::adapters::AdoptReluctantly::communicationSpecification() const {
...
peano::MappingSpecification   dem::adapters::AdoptReluctantly::touchVertexLastTimeSpecification(int level) const {
...
peano::MappingSpecification   dem::adapters::AdoptReluctantly::touchVertexFirstTimeSpecification(int level) const { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::AdoptReluctantly::enterCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::AdoptReluctantly::leaveCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::AdoptReluctantly::ascendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::AdoptReluctantly::descendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
dem::adapters::AdoptReluctantly::AdoptReluctantly() {
}
...
dem::adapters::AdoptReluctantly::AdoptReluctantly(const AdoptReluctantly&  masterThread):
...
void dem::adapters::AdoptReluctantly::mergeWithWorkerThread(const AdoptReluctantly& workerThread) {
...
void dem::adapters::AdoptReluctantly::createHangingVertex(
...
void dem::adapters::AdoptReluctantly::destroyHangingVertex(
...
void dem::adapters::AdoptReluctantly::createInnerVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::AdoptReluctantly::createBoundaryVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::AdoptReluctantly::destroyVertex(
      const dem::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::AdoptReluctantly::createCell(
...
void dem::adapters::AdoptReluctantly::destroyCell(
...
#ifdef Parallel
void dem::adapters::AdoptReluctantly::mergeWithNeighbour(
  dem::Vertex&  vertex,
...
void dem::adapters::AdoptReluctantly::prepareSendToNeighbour(
  dem::Vertex&  vertex,
  int                                           toRank,
...
void dem::adapters::AdoptReluctantly::prepareCopyToRemoteNode(
...
void dem::adapters::AdoptReluctantly::mergeWithRemoteDataDueToForkOrJoin(
  dem::Vertex&  localVertex,
...
bool dem::adapters::AdoptReluctantly::prepareSendToWorker(
  dem::Cell&                 fineGridCell,
  dem::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::AdoptReluctantly::prepareSendToMaster(
  dem::Cell&                       localCell,
  dem::Vertex *                    vertices,
...
void dem::adapters::AdoptReluctantly::mergeWithMaster(
...
void dem::adapters::AdoptReluctantly::receiveDataFromMaster(
...
void dem::adapters::AdoptReluctantly::mergeWithWorker(
  dem::Cell&           localCell, 
...
void dem::adapters::AdoptReluctantly::touchVertexFirstTime(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::AdoptReluctantly::touchVertexLastTime(
      dem::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::AdoptReluctantly::enterCell(
      dem::Cell&                 fineGridCell,
      dem::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::AdoptReluctantly::leaveCell(
      dem::Cell&           fineGridCell,
      dem::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::AdoptReluctantly::beginIteration(
...
void dem::adapters::AdoptReluctantly::endIteration(
  dem::State&  solverState
) {
...
void dem::adapters::AdoptReluctantly::descend(
...
void dem::adapters::AdoptReluctantly::ascend(
  dem::Cell * const    fineGridCells,
  dem::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  dem::Vertex * const  coarseGridVertices,
