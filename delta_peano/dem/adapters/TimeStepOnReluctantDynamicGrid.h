...
#ifndef DEM_ADAPTERS_TimeStepOnReluctantDynamicGrid_H_
#define DEM_ADAPTERS_TimeStepOnReluctantDynamicGrid_H_
...
namespace dem {
      namespace adapters {
        class TimeStepOnReluctantDynamicGrid;
      } 
}
...
class dem::adapters::TimeStepOnReluctantDynamicGrid {
  ...
  public:
    ...
    TimeStepOnReluctantDynamicGrid();

    #if defined(SharedMemoryParallelisation)
    TimeStepOnReluctantDynamicGrid(const TimeStepOnReluctantDynamicGrid& masterThread);
    #endif

    virtual ~TimeStepOnReluctantDynamicGrid();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const TimeStepOnReluctantDynamicGrid& workerThread);
    #endif
