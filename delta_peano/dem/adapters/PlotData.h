...
#ifndef DEM_ADAPTERS_PlotData_H_
#define DEM_ADAPTERS_PlotData_H_
...
class dem::adapters::PlotData {
  ...
  public:
    ...
    PlotData(const PlotData& masterThread);
    #endif

    virtual ~PlotData();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const PlotData& workerThread);
    #endif
