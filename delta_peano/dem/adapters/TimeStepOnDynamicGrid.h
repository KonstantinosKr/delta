...
#ifndef DEM_ADAPTERS_TimeStepOnDynamicGrid_H_
#define DEM_ADAPTERS_TimeStepOnDynamicGrid_H_
 ...
 */
class dem::adapters::TimeStepOnDynamicGrid {
  private:
  ...
  public:
    ...
    TimeStepOnDynamicGrid();

    #if defined(SharedMemoryParallelisation)
    TimeStepOnDynamicGrid(const TimeStepOnDynamicGrid& masterThread);
    #endif

    virtual ~TimeStepOnDynamicGrid();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const TimeStepOnDynamicGrid& workerThread);
    #endif
