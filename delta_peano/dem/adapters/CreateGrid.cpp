...
dem::adapters::CreateGrid::CreateGrid() {
}
...
dem::adapters::CreateGrid::CreateGrid(const CreateGrid&  masterThread):
...
void dem::adapters::CreateGrid::mergeWithWorkerThread(const CreateGrid& workerThread) {
...
void dem::adapters::CreateGrid::createHangingVertex(
...
void dem::adapters::CreateGrid::destroyHangingVertex(
...
void dem::adapters::CreateGrid::createInnerVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::CreateGrid::createBoundaryVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::CreateGrid::destroyVertex(
      const dem::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::CreateGrid::createCell(
...
void dem::adapters::CreateGrid::destroyCell(
...
#ifdef Parallel
void dem::adapters::CreateGrid::mergeWithNeighbour(
  dem::Vertex&  vertex,
...
void dem::adapters::CreateGrid::prepareSendToNeighbour(
  dem::Vertex&  vertex,
  int                                           toRank,
...
void dem::adapters::CreateGrid::prepareCopyToRemoteNode(
...
void dem::adapters::CreateGrid::mergeWithRemoteDataDueToForkOrJoin(
  dem::Vertex&  localVertex,
...
bool dem::adapters::CreateGrid::prepareSendToWorker(
  dem::Cell&                 fineGridCell,
  dem::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::CreateGrid::prepareSendToMaster(
  dem::Cell&                       localCell,
  dem::Vertex *                    vertices,
...
void dem::adapters::CreateGrid::mergeWithMaster(
...
void dem::adapters::CreateGrid::receiveDataFromMaster(
...
void dem::adapters::CreateGrid::mergeWithWorker(
  dem::Cell&           localCell, 
...
void dem::adapters::CreateGrid::touchVertexFirstTime(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::CreateGrid::touchVertexLastTime(
      dem::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::CreateGrid::enterCell(
      dem::Cell&                 fineGridCell,
      dem::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::CreateGrid::leaveCell(
      dem::Cell&           fineGridCell,
      dem::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::CreateGrid::beginIteration(
...
void dem::adapters::CreateGrid::endIteration(
  dem::State&  solverState
) {
...
void dem::adapters::CreateGrid::descend(
...
void dem::adapters::CreateGrid::ascend(
  dem::Cell * const    fineGridCells,
  dem::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  dem::Vertex * const  coarseGridVertices,
