...
#ifndef DEM_MAPPINGS_Collision_H_
...
class dem::mappings::Collision {
  ...
  public:
     ...
     */
    static bool triggerParticleTooClose(
        const records::Particle& particleA,
        const records::Particle& particleB,
        State& state);
   ...
   */
  Collision(const Collision& masterThread);
#endif
   ...
   */
  void mergeWithWorkerThread(const Collision& workerThread);
#endif
