...
#ifndef DEM_MAPPINGS_AdoptGridMerged_H_
#define DEM_MAPPINGS_AdoptGridMerged_H_
 ...
 */
class dem::mappings::AdoptGridMerged {
  private:
    /**
  ...
  public:
     ...
     */
    AdoptGridMerged(const AdoptGridMerged& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~AdoptGridMerged();
     ...
     */   
    void mergeWithWorkerThread(const AdoptGridMerged& workerThread);
    #endif
