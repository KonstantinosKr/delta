...
#ifndef DEM_MAPPINGS_ReluctantlyAdoptGrid_H_
#define DEM_MAPPINGS_ReluctantlyAdoptGrid_H_
 ...
 */
class dem::mappings::ReluctantlyAdoptGrid {
  private:
    /**
   ...
   */
  ReluctantlyAdoptGrid(const ReluctantlyAdoptGrid& masterThread);
#endif
  
  /**
   * Destructor. Typically does not implement any operation.
   */
  virtual ~ReluctantlyAdoptGrid();
   ...
   */
  void mergeWithWorkerThread(const ReluctantlyAdoptGrid& workerThread);
#endif
