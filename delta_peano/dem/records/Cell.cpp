#include "dem/records/Cell.h"
   ...
   dem::records::CellPacked dem::records::Cell::convert() const{
      ...
      void dem::records::Cell::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, ExchangeMode mode) {
         // ============================= 
...
// ============================= 
      ...
      void dem::records::Cell::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, ExchangeMode mode) {
         // ============================= 
// start injected snippet/aspect 
// ============================= 
MPI_Status status; 
...
// =========================== 
   ...
   dem::records::Cell dem::records::CellPacked::convert() const{
      ...
      void dem::records::CellPacked::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, ExchangeMode mode) {
         // ============================= 
// start injected snippet/aspect 
// ============================= 
switch (mode) { 
...
// ============================= 
      ...
      void dem::records::CellPacked::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, ExchangeMode mode) {
         // ============================= 
// start injected snippet/aspect 
// ============================= 
MPI_Status status; 
