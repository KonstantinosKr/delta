...
#ifndef _DEM_REPOSITORIES_REPOSITORY_ARRAY_STD_H_ 
#define _DEM_REPOSITORIES_REPOSITORY_ARRAY_STD_H_ 
...
class dem::repositories::RepositorySTDStack: public dem::repositories::Repository {
  private:
    static tarch::logging::Log _log;
  
    peano::geometry::Geometry& _geometry;
    
    typedef peano::stacks::CellSTDStack<dem::Cell>       CellStack;
    typedef peano::stacks::VertexSTDStack<dem::Vertex>   VertexStack;
