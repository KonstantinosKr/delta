...
void tarch::plotter::griddata::unstructured::vtk::VTUTextFileWriter::CellDataWriter::assignRemainingCellsDefaultValues() {
  assertion4(
...
void tarch::plotter::griddata::unstructured::vtk::VTUTextFileWriter::CellDataWriter::close() {
...
void tarch::plotter::griddata::unstructured::vtk::VTUTextFileWriter::CellDataWriter::plotCell( int index, double value ) {
...
void tarch::plotter::griddata::unstructured::vtk::VTUTextFileWriter::CellDataWriter::plotCell( int index, const tarch::la::Vector<2,double>& value ) {
  assertion(_lastWriteCommandCellNumber>=-1);
...
void tarch::plotter::griddata::unstructured::vtk::VTUTextFileWriter::CellDataWriter::plotCell( int index, const tarch::la::Vector<3,double>& value ) {
  assertion(_lastWriteCommandCellNumber>=-1);
...
void tarch::plotter::griddata::unstructured::vtk::VTUTextFileWriter::CellDataWriter::plotCell( int index, double* values, int numberOfValues ) {
  assertion(_lastWriteCommandCellNumber>=-1);
...
double tarch::plotter::griddata::unstructured::vtk::VTUTextFileWriter::CellDataWriter::getMinValue() const {
  return _minValue;
}


double tarch::plotter::griddata::unstructured::vtk::VTUTextFileWriter::CellDataWriter::getMaxValue() const {
  return _maxValue;
}
