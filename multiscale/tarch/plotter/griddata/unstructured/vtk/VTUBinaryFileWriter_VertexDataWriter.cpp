...
void tarch::plotter::griddata::unstructured::vtk::VTUBinaryFileWriter::VertexDataWriter::assignRemainingVerticesDefaultValues() {
  assertion4(
...
void tarch::plotter::griddata::unstructured::vtk::VTUBinaryFileWriter::VertexDataWriter::plotVertex( int index, double value ) {
...
void tarch::plotter::griddata::unstructured::vtk::VTUBinaryFileWriter::VertexDataWriter::plotVertex( int index, const tarch::la::Vector<2,double>& value ) {
  assertion(_lastWriteCommandVertexNumber>=-1);
...
void tarch::plotter::griddata::unstructured::vtk::VTUBinaryFileWriter::VertexDataWriter::plotVertex( int index, const tarch::la::Vector<3,double>& value ) {
  assertion(_lastWriteCommandVertexNumber>=-1);
...
void tarch::plotter::griddata::unstructured::vtk::VTUBinaryFileWriter::VertexDataWriter::plotVertex( int index, double* values, int numberOfValues ) {
  assertion(_lastWriteCommandVertexNumber>=-1);
...
double tarch::plotter::griddata::unstructured::vtk::VTUBinaryFileWriter::VertexDataWriter::getMinValue() const {
  return _minValue;
}


double tarch::plotter::griddata::unstructured::vtk::VTUBinaryFileWriter::VertexDataWriter::getMaxValue() const {
  return _maxValue;
}
