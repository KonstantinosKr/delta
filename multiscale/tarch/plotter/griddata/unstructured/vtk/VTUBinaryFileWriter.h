...
#ifndef _TARCH_PLOTTER_GRIDDATA_UNSTRUCTURED_VTU_VTU_BINARY_FILEWRITER_H_
#define _TARCH_PLOTTER_GRIDDATA_UNSTRUCTURED_VTU_VTU_BINARY_FILEWRITER_H_
 ...
 * !! Usage
 *
 * - Create an instance of the VTUBinaryFileWriter.
 ...
 */
class tarch::plotter::griddata::unstructured::vtk::VTUBinaryFileWriter:
  ...
  public:
    VTUBinaryFileWriter(const int precision=6);
    virtual ~VTUBinaryFileWriter();
     ...
     * close the underlying VTUBinaryFileWriter.
     */
    class VertexWriter:
      ...
      private:
         ...
         */
        friend class VTUBinaryFileWriter;
        ...
        VertexWriter(VTUBinaryFileWriter& writer, std::string datatype);
    ...
    class CellWriter:
      ...
      private:
        ...
        CellWriter(VTUBinaryFileWriter& writer, std::string datatype);
    ...
    class CellDataWriter:
      public tarch::plotter::griddata::Writer::CellDataWriter {
        private:
          ...
          double _minValue;
          double _maxValue;
          CellDataWriter(const std::string& dataIdentifier, VTUBinaryFileWriter& writer, int recordsPerCell, std::string dataType);
    ...
    class VertexDataWriter:
      public tarch::plotter::griddata::Writer::VertexDataWriter {
        ...
        VertexDataWriter(const std::string& dataIdentifier, VTUBinaryFileWriter& writer, int recordsPerVertex, std::string dataType);
