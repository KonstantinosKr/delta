...
#ifndef _PEANO_PARALLEL_SEND_RECEIVE_BUFFER_FIFO_H_
#define _PEANO_PARALLEL_SEND_RECEIVE_BUFFER_FIFO_H_
 ...
 */
template <class Vertex>
class peano::parallel::SendReceiveBufferFIFO: public peano::parallel::SendReceiveBufferAbstractImplementation<Vertex> {
  private:
    /**
     * Log device.
     */
  ...
  public:
     ...
     */
    SendReceiveBufferFIFO( int toRank, int bufferSize );

    virtual ~SendReceiveBufferFIFO();
...
#include "peano/parallel/SendReceiveBufferFIFO.cpph"
