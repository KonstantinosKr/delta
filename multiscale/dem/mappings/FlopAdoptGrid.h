...
#ifndef DEM_MAPPINGS_FlopAdoptGrid_H_
#define DEM_MAPPINGS_FlopAdoptGrid_H_
 ...
 */
class dem::mappings::FlopAdoptGrid {
  private:
    /**
    ...
    static tarch::multicore::BooleanSemaphore        _FlopAdoptSemaphore;
  ...
  public:
     ...
     */
    FlopAdoptGrid(const FlopAdoptGrid& masterThread);
    #endif

    /**
     * Destructor. Typically does not implement any operation.
     */
    virtual ~FlopAdoptGrid();
     ...
     */   
    void mergeWithWorkerThread(const FlopAdoptGrid& workerThread);
    #endif
