...
#ifndef DEM_ADAPTERS_Adopt_H_
#define DEM_ADAPTERS_Adopt_H_
...
class dem::adapters::Adopt {
  ...
  public:
    ...
    Adopt(const Adopt& masterThread);
    #endif

    virtual ~Adopt();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const Adopt& workerThread);
    #endif
