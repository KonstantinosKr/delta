...
peano::CommunicationSpecification   dem::adapters::TimeStepOnFlopDynamicGrid::communicationSpecification() const {
...
peano::MappingSpecification   dem::adapters::TimeStepOnFlopDynamicGrid::touchVertexLastTimeSpecification(int level) const {
...
peano::MappingSpecification   dem::adapters::TimeStepOnFlopDynamicGrid::touchVertexFirstTimeSpecification(int level) const { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::TimeStepOnFlopDynamicGrid::enterCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::TimeStepOnFlopDynamicGrid::leaveCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::TimeStepOnFlopDynamicGrid::ascendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::TimeStepOnFlopDynamicGrid::descendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
dem::adapters::TimeStepOnFlopDynamicGrid::TimeStepOnFlopDynamicGrid() {
}
...
dem::adapters::TimeStepOnFlopDynamicGrid::TimeStepOnFlopDynamicGrid(const TimeStepOnFlopDynamicGrid&  masterThread):
...
void dem::adapters::TimeStepOnFlopDynamicGrid::mergeWithWorkerThread(const TimeStepOnFlopDynamicGrid& workerThread) {
...
void dem::adapters::TimeStepOnFlopDynamicGrid::createHangingVertex(
...
void dem::adapters::TimeStepOnFlopDynamicGrid::destroyHangingVertex(
...
void dem::adapters::TimeStepOnFlopDynamicGrid::createInnerVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStepOnFlopDynamicGrid::createBoundaryVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStepOnFlopDynamicGrid::destroyVertex(
      const dem::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::TimeStepOnFlopDynamicGrid::createCell(
...
void dem::adapters::TimeStepOnFlopDynamicGrid::destroyCell(
...
#ifdef Parallel
void dem::adapters::TimeStepOnFlopDynamicGrid::mergeWithNeighbour(
  dem::Vertex&  vertex,
...
void dem::adapters::TimeStepOnFlopDynamicGrid::prepareSendToNeighbour(
  dem::Vertex&  vertex,
  int                                           toRank,
...
void dem::adapters::TimeStepOnFlopDynamicGrid::prepareCopyToRemoteNode(
...
void dem::adapters::TimeStepOnFlopDynamicGrid::mergeWithRemoteDataDueToForkOrJoin(
  dem::Vertex&  localVertex,
...
bool dem::adapters::TimeStepOnFlopDynamicGrid::prepareSendToWorker(
  dem::Cell&                 fineGridCell,
  dem::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStepOnFlopDynamicGrid::prepareSendToMaster(
  dem::Cell&                       localCell,
  dem::Vertex *                    vertices,
...
void dem::adapters::TimeStepOnFlopDynamicGrid::mergeWithMaster(
...
void dem::adapters::TimeStepOnFlopDynamicGrid::receiveDataFromMaster(
...
void dem::adapters::TimeStepOnFlopDynamicGrid::mergeWithWorker(
  dem::Cell&           localCell, 
...
void dem::adapters::TimeStepOnFlopDynamicGrid::touchVertexFirstTime(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStepOnFlopDynamicGrid::touchVertexLastTime(
      dem::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::TimeStepOnFlopDynamicGrid::enterCell(
      dem::Cell&                 fineGridCell,
      dem::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStepOnFlopDynamicGrid::leaveCell(
      dem::Cell&           fineGridCell,
      dem::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::TimeStepOnFlopDynamicGrid::beginIteration(
...
void dem::adapters::TimeStepOnFlopDynamicGrid::endIteration(
  dem::State&  solverState
) {
...
void dem::adapters::TimeStepOnFlopDynamicGrid::descend(
...
void dem::adapters::TimeStepOnFlopDynamicGrid::ascend(
  dem::Cell * const    fineGridCells,
  dem::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  dem::Vertex * const  coarseGridVertices,
