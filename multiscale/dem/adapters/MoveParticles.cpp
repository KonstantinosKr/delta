...
peano::CommunicationSpecification   dem::adapters::MoveParticles::communicationSpecification() const {
...
peano::MappingSpecification   dem::adapters::MoveParticles::touchVertexLastTimeSpecification(int level) const {
...
peano::MappingSpecification   dem::adapters::MoveParticles::touchVertexFirstTimeSpecification(int level) const { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::MoveParticles::enterCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::MoveParticles::leaveCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::MoveParticles::ascendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   dem::adapters::MoveParticles::descendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
dem::adapters::MoveParticles::MoveParticles() {
}
...
dem::adapters::MoveParticles::MoveParticles(const MoveParticles&  masterThread):
...
void dem::adapters::MoveParticles::mergeWithWorkerThread(const MoveParticles& workerThread) {
...
void dem::adapters::MoveParticles::createHangingVertex(
...
void dem::adapters::MoveParticles::destroyHangingVertex(
...
void dem::adapters::MoveParticles::createInnerVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::MoveParticles::createBoundaryVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::MoveParticles::destroyVertex(
      const dem::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::MoveParticles::createCell(
...
void dem::adapters::MoveParticles::destroyCell(
...
#ifdef Parallel
void dem::adapters::MoveParticles::mergeWithNeighbour(
  dem::Vertex&  vertex,
...
void dem::adapters::MoveParticles::prepareSendToNeighbour(
  dem::Vertex&  vertex,
  int                                           toRank,
...
void dem::adapters::MoveParticles::prepareCopyToRemoteNode(
...
void dem::adapters::MoveParticles::mergeWithRemoteDataDueToForkOrJoin(
  dem::Vertex&  localVertex,
...
bool dem::adapters::MoveParticles::prepareSendToWorker(
  dem::Cell&                 fineGridCell,
  dem::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::MoveParticles::prepareSendToMaster(
  dem::Cell&                       localCell,
  dem::Vertex *                    vertices,
...
void dem::adapters::MoveParticles::mergeWithMaster(
...
void dem::adapters::MoveParticles::receiveDataFromMaster(
...
void dem::adapters::MoveParticles::mergeWithWorker(
  dem::Cell&           localCell, 
...
void dem::adapters::MoveParticles::touchVertexFirstTime(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::MoveParticles::touchVertexLastTime(
      dem::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::MoveParticles::enterCell(
      dem::Cell&                 fineGridCell,
      dem::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::MoveParticles::leaveCell(
      dem::Cell&           fineGridCell,
      dem::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::MoveParticles::beginIteration(
...
void dem::adapters::MoveParticles::endIteration(
  dem::State&  solverState
) {
...
void dem::adapters::MoveParticles::descend(
...
void dem::adapters::MoveParticles::ascend(
  dem::Cell * const    fineGridCells,
  dem::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  dem::Vertex * const  coarseGridVertices,
