...
#ifndef DEM_ADAPTERS_MoveParticles_H_
#define DEM_ADAPTERS_MoveParticles_H_
 ...
 */
class dem::adapters::MoveParticles {
  private:
    typedef mappings::MoveParticles Mapping0;

     Mapping0  _map2MoveParticles;
