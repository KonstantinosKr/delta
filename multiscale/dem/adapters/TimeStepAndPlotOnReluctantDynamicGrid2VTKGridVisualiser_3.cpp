...
std::map<tarch::la::Vector<DIMENSIONS,double> , int, tarch::la::StrictVectorCompare<DIMENSIONS> >  dem::adapters::TimeStepAndPlotOnReluctantDynamicGrid2VTKGridVisualiser_3::_vertex2IndexMap;

dem::adapters::TimeStepAndPlotOnReluctantDynamicGrid2VTKGridVisualiser_3::UsedWriter*                                                          dem::adapters::TimeStepAndPlotOnReluctantDynamicGrid2VTKGridVisualiser_3::_vtkWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexWriter*                                             dem::adapters::TimeStepAndPlotOnReluctantDynamicGrid2VTKGridVisualiser_3::_vertexWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::CellWriter*                                               dem::adapters::TimeStepAndPlotOnReluctantDynamicGrid2VTKGridVisualiser_3::_cellWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexDataWriter*                                         dem::adapters::TimeStepAndPlotOnReluctantDynamicGrid2VTKGridVisualiser_3::_vertexTypeWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexDataWriter*                                         dem::adapters::TimeStepAndPlotOnReluctantDynamicGrid2VTKGridVisualiser_3::_vertexRefinementControlWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexDataWriter*                                         dem::adapters::TimeStepAndPlotOnReluctantDynamicGrid2VTKGridVisualiser_3::_vertexAdjacentCellsHeight = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::CellDataWriter*                                           dem::adapters::TimeStepAndPlotOnReluctantDynamicGrid2VTKGridVisualiser_3::_cellStateWriter = nullptr;
