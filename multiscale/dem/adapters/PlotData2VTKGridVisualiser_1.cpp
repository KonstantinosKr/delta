...
int dem::adapters::PlotData2VTKGridVisualiser_1::_snapshotCounter = 0;
...
std::map<tarch::la::Vector<DIMENSIONS,double> , int, tarch::la::VectorCompare<DIMENSIONS> >  dem::adapters::PlotData2VTKGridVisualiser_1::_vertex2IndexMap;
