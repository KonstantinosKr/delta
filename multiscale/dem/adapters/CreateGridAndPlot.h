...
#ifndef DEM_ADAPTERS_CreateGridAndPlot_H_
#define DEM_ADAPTERS_CreateGridAndPlot_H_
 ...
 */
class dem::adapters::CreateGridAndPlot {
  private:
  ...
  public:
    ...
    CreateGridAndPlot(const CreateGridAndPlot& masterThread);
    #endif

    virtual ~CreateGridAndPlot();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const CreateGridAndPlot& workerThread);
    #endif
