...
std::map<tarch::la::Vector<DIMENSIONS,double> , int, tarch::la::StrictVectorCompare<DIMENSIONS> >  dem::adapters::CreateGridAndPlot2VTKGridVisualiser_2::_vertex2IndexMap;

dem::adapters::CreateGridAndPlot2VTKGridVisualiser_2::UsedWriter*                                                          dem::adapters::CreateGridAndPlot2VTKGridVisualiser_2::_vtkWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexWriter*                                             dem::adapters::CreateGridAndPlot2VTKGridVisualiser_2::_vertexWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::CellWriter*                                               dem::adapters::CreateGridAndPlot2VTKGridVisualiser_2::_cellWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexDataWriter*                                         dem::adapters::CreateGridAndPlot2VTKGridVisualiser_2::_vertexTypeWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexDataWriter*                                         dem::adapters::CreateGridAndPlot2VTKGridVisualiser_2::_vertexRefinementControlWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexDataWriter*                                         dem::adapters::CreateGridAndPlot2VTKGridVisualiser_2::_vertexAdjacentCellsHeight = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::CellDataWriter*                                           dem::adapters::CreateGridAndPlot2VTKGridVisualiser_2::_cellStateWriter = nullptr;
