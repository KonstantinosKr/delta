...
#ifndef DEM_ADAPTERS_FlopAdopt_H_
#define DEM_ADAPTERS_FlopAdopt_H_
...
class dem::adapters::FlopAdopt {
  ...
  public:
    ...
    FlopAdopt(const FlopAdopt& masterThread);
    #endif

    virtual ~FlopAdopt();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const FlopAdopt& workerThread);
    #endif
