...
#ifndef DEM_ADAPTERS_TimeStepAndPlotOnDynamicGrid_H_
#define DEM_ADAPTERS_TimeStepAndPlotOnDynamicGrid_H_
...
namespace dem {
      namespace adapters {
        class TimeStepAndPlotOnDynamicGrid;
      } 
}
...
class dem::adapters::TimeStepAndPlotOnDynamicGrid {
  private:
    typedef mappings::AdoptGrid Mapping0;
  ...
  public:
    ...
    TimeStepAndPlotOnDynamicGrid();

    #if defined(SharedMemoryParallelisation)
    TimeStepAndPlotOnDynamicGrid(const TimeStepAndPlotOnDynamicGrid& masterThread);
    #endif

    virtual ~TimeStepAndPlotOnDynamicGrid();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const TimeStepAndPlotOnDynamicGrid& workerThread);
    #endif
