...
#ifndef DEM_ADAPTERS_AdoptFlop_H_
#define DEM_ADAPTERS_AdoptFlop_H_
 ...
 */
class dem::adapters::AdoptFlop {
  private:
    typedef mappings::FlopAdoptGrid Mapping0;

     Mapping0  _map2FlopAdoptGrid;
  ...
  public:
    ...
    AdoptFlop(const AdoptFlop& masterThread);
    #endif

    virtual ~AdoptFlop();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const AdoptFlop& workerThread);
    #endif
