...
#ifndef DEM_ADAPTERS_TimeStepAndPlotOnFlopDynamicGrid_H_
#define DEM_ADAPTERS_TimeStepAndPlotOnFlopDynamicGrid_H_
...
namespace dem {
      namespace adapters {
        class TimeStepAndPlotOnFlopDynamicGrid;
      } 
}
 ...
 */
class dem::adapters::TimeStepAndPlotOnFlopDynamicGrid {
  private:
    typedef mappings::ReluctantlyAdoptGrid Mapping0;
    typedef mappings::MoveParticles Mapping1;
    typedef mappings::Plot Mapping2;
    typedef adapters::TimeStepAndPlotOnFlopDynamicGrid2VTKGridVisualiser_3 Mapping3;

     Mapping0  _map2ReluctantlyAdoptGrid;
     Mapping1  _map2MoveParticles;
     Mapping2  _map2Plot;
     Mapping3  _map2TimeStepAndPlotOnFlopDynamicGrid2VTKGridVisualiser_3;
  ...
  public:
    ...
    TimeStepAndPlotOnFlopDynamicGrid();

    #if defined(SharedMemoryParallelisation)
    TimeStepAndPlotOnFlopDynamicGrid(const TimeStepAndPlotOnFlopDynamicGrid& masterThread);
    #endif

    virtual ~TimeStepAndPlotOnFlopDynamicGrid();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const TimeStepAndPlotOnFlopDynamicGrid& workerThread);
    #endif
