...
#ifndef DEM_ADAPTERS_AdoptReluctantly_H_
#define DEM_ADAPTERS_AdoptReluctantly_H_
 ...
 */
class dem::adapters::AdoptReluctantly {
  private:
  ...
  public:
    ...
    AdoptReluctantly(const AdoptReluctantly& masterThread);
    #endif

    virtual ~AdoptReluctantly();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const AdoptReluctantly& workerThread);
    #endif
