...
dem::adapters::TimeStepAndPlot::TimeStepAndPlot() {
}
...
void dem::adapters::TimeStepAndPlot::mergeWithWorkerThread(const TimeStepAndPlot& workerThread) {
  ...
  _map2TimeStepAndPlot2VTKGridVisualiser_3.mergeWithWorkerThread(workerThread._map2TimeStepAndPlot2VTKGridVisualiser_3);

}
#endif


void dem::adapters::TimeStepAndPlot::createHangingVertex(
...
void dem::adapters::TimeStepAndPlot::destroyHangingVertex(
...
void dem::adapters::TimeStepAndPlot::createInnerVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStepAndPlot::createBoundaryVertex(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStepAndPlot::destroyVertex(
      const dem::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::TimeStepAndPlot::createCell(
...
void dem::adapters::TimeStepAndPlot::destroyCell(
...
#ifdef Parallel
void dem::adapters::TimeStepAndPlot::mergeWithNeighbour(
  dem::Vertex&  vertex,
  ...
  int                                           level
   ...
   _map2TimeStepAndPlot2VTKGridVisualiser_3.mergeWithNeighbour( vertex, neighbour, fromRank, fineGridX, fineGridH, level );

}


void dem::adapters::TimeStepAndPlot::prepareSendToNeighbour(
  dem::Vertex&  vertex,
  int                                           toRank,
  ...
  int                                           level
   ...
   _map2TimeStepAndPlot2VTKGridVisualiser_3.prepareSendToNeighbour( vertex, toRank, x, h, level );

}


void dem::adapters::TimeStepAndPlot::prepareCopyToRemoteNode(
  ...
  int                                           level
   ...
   _map2TimeStepAndPlot2VTKGridVisualiser_3.prepareCopyToRemoteNode( localVertex, toRank, x, h, level );
...
void dem::adapters::TimeStepAndPlot::prepareCopyToRemoteNode(
  dem::Cell&  localCell,
   ...
   _map2TimeStepAndPlot2VTKGridVisualiser_3.prepareCopyToRemoteNode( localCell, toRank, x, h, level );

}


void dem::adapters::TimeStepAndPlot::mergeWithRemoteDataDueToForkOrJoin(
  dem::Vertex&  localVertex,
  ...
  int                                       level
   ...
   _map2TimeStepAndPlot2VTKGridVisualiser_3.mergeWithRemoteDataDueToForkOrJoin( localVertex, masterOrWorkerVertex, fromRank, x, h, level );
...
void dem::adapters::TimeStepAndPlot::mergeWithRemoteDataDueToForkOrJoin(
  ...
  int                                       level
   ...
   _map2TimeStepAndPlot2VTKGridVisualiser_3.mergeWithRemoteDataDueToForkOrJoin( localCell, masterOrWorkerCell, fromRank, x, h, level );

}


bool dem::adapters::TimeStepAndPlot::prepareSendToWorker(
  dem::Cell&                 fineGridCell,
  dem::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  dem::Vertex * const        coarseGridVertices,
  ...
  bool result = false;
   ...
   result |= _map2TimeStepAndPlot2VTKGridVisualiser_3.prepareSendToWorker( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell, worker );

  return result;
}


void dem::adapters::TimeStepAndPlot::prepareSendToMaster(
  dem::Cell&                       localCell,
  dem::Vertex *                    vertices,
  ...
  const tarch::la::Vector<DIMENSIONS,int>&   fineGridPositionOfCell
   ...
   _map2TimeStepAndPlot2VTKGridVisualiser_3.prepareSendToMaster( localCell, vertices, verticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );

}


void dem::adapters::TimeStepAndPlot::mergeWithMaster(
  ...
  dem::State&                masterState
   ...
   _map2TimeStepAndPlot2VTKGridVisualiser_3.mergeWithMaster( workerGridCell, workerGridVertices, workerEnumerator, fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell, worker, workerState, masterState );

}


void dem::adapters::TimeStepAndPlot::receiveDataFromMaster(
...
void dem::adapters::TimeStepAndPlot::mergeWithWorker(
  ...
  int                                          level
   ...
   _map2TimeStepAndPlot2VTKGridVisualiser_3.mergeWithWorker( localCell, receivedMasterCell, cellCentre, cellSize, level );
...
void dem::adapters::TimeStepAndPlot::mergeWithWorker(
  ...
  int                                           level
   ...
   _map2TimeStepAndPlot2VTKGridVisualiser_3.mergeWithWorker( localVertex, receivedMasterVertex, x, h, level );

}
#endif


void dem::adapters::TimeStepAndPlot::touchVertexFirstTime(
      dem::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStepAndPlot::touchVertexLastTime(
      dem::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::TimeStepAndPlot::enterCell(
      dem::Cell&                 fineGridCell,
      dem::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      dem::Vertex * const        coarseGridVertices,
...
void dem::adapters::TimeStepAndPlot::leaveCell(
      dem::Cell&           fineGridCell,
      dem::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      dem::Vertex * const  coarseGridVertices,
...
void dem::adapters::TimeStepAndPlot::beginIteration(
...
void dem::adapters::TimeStepAndPlot::endIteration(
  dem::State&  solverState
) {
...
void dem::adapters::TimeStepAndPlot::descend(
...
void dem::adapters::TimeStepAndPlot::ascend(
  dem::Cell * const    fineGridCells,
  dem::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  dem::Vertex * const  coarseGridVertices,
