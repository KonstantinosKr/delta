...
peano::CommunicationSpecification   dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::communicationSpecification() const {
  return peano::CommunicationSpecification::getPessimisticSpecification();
}


peano::MappingSpecification   dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::touchVertexLastTimeSpecification(int level) const {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::RunConcurrentlyOnFineGrid,true);
}


peano::MappingSpecification   dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::touchVertexFirstTimeSpecification(int level) const { 
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::Serial,true);
}


peano::MappingSpecification   dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::enterCellSpecification(int level) const {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::AvoidFineGridRaces,true);
}


peano::MappingSpecification   dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::leaveCellSpecification(int level) const {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::Serial,true);
}


peano::MappingSpecification   dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::ascendSpecification(int level) const {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::RunConcurrentlyOnFineGrid,true);
}


peano::MappingSpecification   dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::descendSpecification(int level) const {
  return peano::MappingSpecification(peano::MappingSpecification::Nop,peano::MappingSpecification::RunConcurrentlyOnFineGrid,true);
}


std::map<tarch::la::Vector<DIMENSIONS,double> , int, tarch::la::StrictVectorCompare<DIMENSIONS> >  dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::_vertex2IndexMap;

dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::UsedWriter*                                                          dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::_vtkWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexWriter*                                             dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::_vertexWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::CellWriter*                                               dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::_cellWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexDataWriter*                                         dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::_vertexTypeWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexDataWriter*                                         dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::_vertexRefinementControlWriter = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::VertexDataWriter*                                         dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::_vertexAdjacentCellsHeight = nullptr;
tarch::plotter::griddata::unstructured::UnstructuredGridWriter::CellDataWriter*                                           dem::adapters::TimeStepAndPlotOnDynamicGrid2VTKGridVisualiser_4::_cellStateWriter = nullptr;
